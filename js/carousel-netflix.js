...
class UnitsCarousel {
  ...
  createIndicators() {
    ...
    this.indicators = Array.from(
      this.indicatorsContainer.querySelectorAll(".indicator-dot")
    );
  }
  ...
  updateCarousel() {
    ...
    const announcement = `Showing unit ${this.currentIndex + 1} of ${
      this.slides.length
    }`;
  ...
  updateCarousel() {
    ...
    // Update track position - simple translateX for all devices
    const offset = -this.currentIndex * 100;
    this.track.style.transform = `translateX(${offset}%)`;
    ...
    // Update arrow states (allow looping)
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (carouselContainer) {
    ...
    const units = [
      {
        ...
        price: "KES 12.5M",
        description:
          "Thoughtfully designed 2-bedroom apartment with an optimized layout for modern living. Features include a spacious master bedroom with ensuite, generous living area, and contemporary finishes throughout.",
        features: [
      ...
      },
      {
        ...
        price: "KES 12.5M",
        description:
          "Alternative 2-bedroom layout offering enhanced privacy and functionality. Perfect for small families or professionals seeking quality and comfort in a prime location.",
        features: [
      ...
      },
      {
        ...
        price: "KES 16.5M",
        description:
          "Spacious 3-bedroom executive apartment designed for growing families. Features include three ensuite bedrooms, expansive living areas, and premium finishes that define luxury living.",
        features: [
      ...
      },
      {
        ...
        price: "KES 18.5M",
        description:
          "The pinnacle of luxury living at 6040 Vista. This prestigious apartment features three ensuite bedrooms plus a separate Domestic Staff Quarter, offering unparalleled space and comfort.",
        features: [
          "Three ensuite bedrooms",
                        ...
                        <div class="carousel-slide">
                          ...
                          unit.title
                            ...
                            <div class="slide-content">
                                ...
                                <a href="${
                                  unit.link
                                }" class="carousel-cta">View Floor Plan</a>
                            </div>
                        </div>
                    `
                      )
    ...
    // Initialize carousel
    const carousel = new UnitsCarousel(carouselContainer, {
      autoPlay: true,
